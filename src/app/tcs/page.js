          ...
          <div className="max-w-4xl mx-auto">
            <div className="relative">
              ...
              {tcsInfo.timeline.map((item, index) => (
                <div key={index} className={`relative mb-8 ${index % 2 === 0 ? 'md:text-right md:pr-4' : 'md:text-left md:pl-4'}`}>
                  ...
                  <Card className={`block w-1/2 max-w-md hover:shadow-lg transition-all duration-300 hover:scale-105 ${index % 2 === 0 ? 'md:ml-auto' : 'md:mr-0'}`}>
                    <CardHeader>
